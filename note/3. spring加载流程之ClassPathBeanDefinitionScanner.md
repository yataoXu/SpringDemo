继上篇spring加载流程之AnnotatedBeanDefinitionReader之后，按照spring加载流程继续分析`ClassPathBeanDefinitionScanner`扫描器
...
```
这里的registry是this.scanner = new ClassPathBeanDefinitionScanner(this);中的this也就是AnnotationConfigApplicationContext
